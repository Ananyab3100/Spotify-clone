...
const MyMusic = () =>{
  ...
  return(
    <LoggedInContainer curActiveScreen = "myMusic">
           <div className="text-white text-xl font-semibold pl-4 pb-2 pt-8">My Songs</div>
...
//               <IconText iconName="material-symbols:library-music" displayText="My Music" active/>   
//            </div>
...
//            </div>
          ...
          //   <div className="text-white text-xl font-semibold pl-4 pb-2">My Songs</div>
          //   <div className="space-y-3 overflow-auto">
          //       {songData.map((item) =>{
